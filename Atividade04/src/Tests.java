...
public class EntreXeY {
	...
	public static void main(String[] args) {
		...
		if( numero1 > numero2)
		{
			...
			JOptionPane.showMessageDialog(null, "Os numeros que estão entre " +numero2+ " e " +numero1+ " são \n" +numeros.toString());
		}
			else if (numero2 > numero1)
			{
				...
				JOptionPane.showMessageDialog(null, "Os numeros que estão entre " +numero1+ " e " +numero2+ " são \n" +numeros.toString());
			}
			else
			{
